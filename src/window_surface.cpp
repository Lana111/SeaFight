...
void WindowSurface::DrawGameMap() const
{
	...
	// FIXME: Откоректировать. Значки перепутаны.
	DrawString("СТАРТ\n  \32", 2, 3, LightGreen);
	DrawString(" -1-", 8, 3, LightBlue);
	DrawString(" $$$", 14, 3, White);
	DrawString(" -1-", 20, 3, LightBlue);
	DrawString(" -$", 26, 3, White);
	DrawString("  A", 32, 3, LightMagenta);
	DrawString(" -2-", 38, 3, LightRed);
	DrawString(" <?>", 44, 3, LightGreen);
	DrawString(" -2-", 50, 3, LightRed);
	DrawString(" -2-", 56, 3, LightRed);
	DrawString(" ###", 62, 3, Yellow);
	DrawString(" -3-", 62, 7, LightCyan);
	DrawString(" (@)", 62, 11, LightRed);
	DrawString(" -3-", 62, 15, LightCyan);
	DrawString(" -3-", 62, 19, LightCyan);
	DrawString(" ЖД", 62, 23, LightMagenta);
	DrawString(" -4-", 62, 27, LightGreen);
	DrawString(" $$$", 62, 31, White);
	DrawString(" -4-", 62, 35, LightGreen);
	DrawString(" -4-", 62, 39, LightGreen);
	DrawString(" Б\14С\n ^ ^", 62, 43, Yellow);
	DrawString(" -5-", 56, 43, Brown);
	DrawString(" <?>", 50, 43, LightGreen);
	DrawString(" -5-", 44, 43, Brown);
	DrawString(" -5-", 38, 43, Brown);
	DrawString("  A", 32, 43, LightMagenta);
	DrawString(" -6-", 26, 43, LightCyan);
	DrawString(" -6-", 20, 43, LightCyan);
	DrawString(" (@)", 14, 43, LightRed);
	DrawString(" -6-", 8, 43, LightCyan);
	DrawString(" \30\30\30", 2, 43, Yellow);
	DrawString(" -7-", 2, 39, LightGreen);
	DrawString(" -7-", 2, 35, LightGreen);
	DrawString(" $$$", 2, 31, White);
	DrawString(" -7-", 2, 27, LightGreen);
	DrawString(" ЖД", 2, 23, LightMagenta);
	DrawString(" <?>", 2, 19, LightGreen);
	DrawString(" -8-", 2, 15, Yellow);
	DrawString(" -$", 2, 11, White);
	DrawString(" -8-", 2, 7, Yellow);
